...
scopes = ['offline.access','bookmark.read','users.read']
...
for twitter_oath_callback_url_port in twitter_oath_callback_url_ports_to_try:
    ...
    twitter_oauth_callback_url = f"{twitter_oauth_callback_url_proto}://{twitter_oauth_callback_url_ip}:{twitter_oath_callback_url_port}/oauth/twitter"
...
# access_credentials_dictionary = oauth2_user_handler.fetch_token( oauth2_user_handler.get_authorization_url())
print(access_credentials_dictionary)
